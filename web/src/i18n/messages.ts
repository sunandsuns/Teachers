...
const ZH = {
  ...
  'nav.profile': '画像',
  'nav.insights': '感悟',
  // 「我的书架」紧挨「书架」：前者是公共书目，后者是自己往里加的书，是同一件事的两面。
  // 「后台」不在这里——它要按管理员身份过滤，见 `layout/nav.ts` 的 `ADMIN_NAV_ITEM`。
  'nav.mine': '我的书架',
  'nav.admin': '后台',
  'lang.group': '切换界面语言',
  'lang.zh': '中文',
  ...
  // 「我的书架」是第四路：它不在公共语料里，是用户自己加的书。
  // 标签上写明"我的"，免得有人以为这是公共书目的一部分。
  'search.kind.shelf': '我的书架',
  'search.badge.source': '原典',
  'search.badge.notes': '笔记',
  'search.badge.shelf': '我的书',
  ...
  'history.clear': '清空',
  // 勾选删除：先进入"选择模式"，卡片上才出现勾选框
  'history.select': '选择',
  'history.exitSelect': '退出选择',
  'history.selectAll': '全选',
  'history.selectNone': '取消全选',
  'history.pickedCount': '已选 {topics} 个话题 · {records} 条记录',
  'history.pickedNone': '勾选要删的内容',
  ...
  'auth.displayName': '昵称（可留空）',
  'auth.displayNamePlaceholder': '希望怎么称呼你',
  'auth.loginAction': '登录',
  'auth.registerAction': '注册并登录',
  ...
  // ── 我的书架 ────────────────────────────────────────────────
  'shelf.title': '我的书架',
  'shelf.description': '{count} 本 · 想读、在读、读过',
  'shelf.findTitle': '找一本书加进来',
  'shelf.findHint': '输入书名（作者可留空），程序会去 OpenLibrary 检索，选哪一本由你定。',
  'shelf.titlePlaceholder': '书名',
  'shelf.authorPlaceholder': '作者（可留空）',
  'shelf.searchAction': '联网检索',
  'shelf.searching': '正在检索…',
  'shelf.noResults': '没有找到这本书',
  'shelf.noResultsHint': '换个说法试试：只写书名，或补上作者。',
  'shelf.add': '加入书架',
  'shelf.adding': '正在加入…',
  'shelf.added': '已在书架里',
  'shelf.addedToast': '《{title}》已加入，导读正在后台生成。',
  'shelf.duplicate': '这本书已经在你的书架里了。',
  'shelf.status.wish': '想读',
  'shelf.status.reading': '在读',
  'shelf.status.done': '读过',
  'shelf.status.all': '全部',
  'shelf.visibility.private': '仅自己',
  'shelf.visibility.pending': '待审核',
  'shelf.visibility.public': '已公开',
  'shelf.visibility.rejected': '已驳回',
  'shelf.empty': '书架还是空的',
  'shelf.emptyHint': '在上面输入书名，从检索结果里挑一本加进来。',
  'shelf.emptyFilter': '这个状态下还没有书',
  'shelf.emptyFilterHint': '切回「全部」看看别的。',
  'shelf.guidePending': '导读生成中…',
  'shelf.guideEmpty': '这本书还没有导读',
  'shelf.guideShow': '展开导读',
  'shelf.guideHide': '收起导读',
  'shelf.submit': '申请公开',
  'shelf.cancelReview': '撤回申请',
  'shelf.remove': '移出书架',
  'shelf.submitted': '已提交，等待管理员审核。',
  'shelf.cancelled': '已撤回公开申请。',
  'shelf.removed': '已移出书架。',
  'shelf.rejectNote': '驳回原因：{note}',
  'shelf.unknownAuthor': '佚名',
  'shelf.setStatus': '改为「{status}」',

  // ── 后台管理 ────────────────────────────────────────────────
  'admin.title': '后台管理',
  'admin.description': '数据总览、新书审核、用户管理，以及直接操作数据库。',
  'admin.tab.overview': '总览',
  'admin.tab.review': '新书审核',
  'admin.tab.users': '用户',
  'admin.tab.db': '数据库',
  'admin.denied': '这一页只对管理员开放',
  'admin.deniedHint': '当前账号不是管理员。用管理员账号登录后再来。',
  'admin.stat.users': '用户',
  'admin.stat.admins': '管理员',
  'admin.stat.history': '问答记录',
  'admin.stat.historyToday': '今日问答',
  'admin.stat.shelf': '书架藏书',
  'admin.stat.shelfToday': '今日新增',
  'admin.stat.pending': '待审核',
  'admin.stat.public': '公共贡献',
  'admin.stat.sessions': '活跃会话',
  'admin.stat.traits': '画像特征',
  'admin.corpus': '语料规模',
  'admin.corpusValue': '{books} 部 · {chapters} 章',
  'admin.storage': '数据库',
  'admin.storageValue': '{size} · {tables} 张表',
  'admin.reviewEmpty': '没有待审的书',
  'admin.reviewEmptyHint': '用户申请公开的书会出现在这里。',
  'admin.approve': '批准公开',
  'admin.reject': '驳回',
  'admin.notePlaceholder': '驳回原因（会显示给作者）',
  'admin.categoryPlaceholder': '归入分类（可留空）',
  'admin.from': '由 {email} 提交',
  'admin.approved': '已批准，这本书已进入公共书架。',
  'admin.rejected': '已驳回。',
  'admin.publicTitle': '公共书架里的贡献',
  'admin.publicEmpty': '还没有用户贡献的书',
  'admin.removePublic': '撤下',
  'admin.usersEmpty': '还没有注册用户',
  'admin.grantAdmin': '设为管理员',
  'admin.revokeAdmin': '取消管理员',
  'admin.resetPassword': '重置密码',
  'admin.deleteUser': '删除用户',
  'admin.shelfCount': '{count} 本',
  'admin.newPassword': '新密码（至少 8 位）',
  'admin.resetDone': '密码已重置，该用户的登录状态已失效。',
  'admin.you': '你',
  'admin.dbTitle': '表',
  'admin.dbRows': '{count} 行',
  'admin.dbEmpty': '这张表是空的',
  'admin.dbProtected': '受保护',
  'admin.dbHint':
    '只有表名与列名都在白名单里的改动才会被接受；密码哈希与 salt 不允许直接修改，请走「重置密码」。每一次写入都会记入审计。',
  'admin.dbSaved': '已保存，并记入审计。',
  'admin.prev': '上一页',
  'admin.next': '下一页',
  'admin.pageOf': '第 {page} 页',
  'admin.auditTitle': '最近操作',
  'admin.auditEmpty': '还没有后台操作记录',
...
const EN: Record<MessageKey, string> = {
  ...
  'library.all': 'All',
  'library.filterLabel': 'Filter by category',
  ...
  'library.emptyHint': 'No books have been loaded into this library yet.',
  'library.emptyCategory': 'Nothing in this category',
  'library.emptyCategoryHint': 'Try another category, or pick “All” to see every book.',
  ...
  'search.kind.shelf': 'My shelf',
  'search.badge.source': 'Source',
  'search.badge.notes': 'Notes',
  'search.badge.shelf': 'My book',
  ...
  'history.exitSelect': 'Done',
  'history.selectAll': 'Select all',
  'history.selectNone': 'Select none',
  'history.pickedCount': '{topics} conversations · {records} records selected',
  'history.pickedNone': 'Tick what you want to delete',
  ...
  'auth.registerAction': 'Create account and sign in',
  ...
  'shelf.description': '{count} books · to read, reading, read',
  'shelf.findTitle': 'Find a book to add',
  'shelf.findHint':
    'Enter a title (author optional). The app searches OpenLibrary — which result to keep is your call.',
  'shelf.titlePlaceholder': 'Title',
  'shelf.authorPlaceholder': 'Author (optional)',
  'shelf.searchAction': 'Search online',
  'shelf.searching': 'Searching…',
  'shelf.noResults': 'No such book found',
  'shelf.noResultsHint': 'Try a different phrasing: just the title, or add the author.',
  'shelf.add': 'Add to shelf',
  'shelf.adding': 'Adding…',
  'shelf.added': 'Already on your shelf',
  'shelf.addedToast': '“{title}” added. The reading guide is being generated.',
  'shelf.duplicate': 'That book is already on your shelf.',
  'shelf.status.wish': 'To read',
  'shelf.status.reading': 'Reading',
  'shelf.status.done': 'Read',
  'shelf.status.all': 'All',
  'shelf.visibility.private': 'Private',
  'shelf.visibility.pending': 'In review',
  'shelf.visibility.public': 'Public',
  'shelf.visibility.rejected': 'Rejected',
  'shelf.empty': 'Your shelf is empty',
  'shelf.emptyHint': 'Type a title above and pick one of the results to add.',
  'shelf.emptyFilter': 'Nothing under this status',
  'shelf.emptyFilterHint': 'Switch back to “All” to see the rest.',
  'shelf.guidePending': 'Generating the reading guide…',
  'shelf.guideEmpty': 'No reading guide yet',
  'shelf.guideShow': 'Show guide',
  'shelf.guideHide': 'Hide guide',
  'shelf.submit': 'Request to publish',
  'shelf.cancelReview': 'Withdraw request',
  'shelf.remove': 'Remove from shelf',
  'shelf.submitted': 'Submitted — waiting for an administrator to review.',
  'shelf.cancelled': 'Publish request withdrawn.',
  'shelf.removed': 'Removed from your shelf.',
  'shelf.rejectNote': 'Reason: {note}',
  'shelf.unknownAuthor': 'Unknown author',
  'shelf.setStatus': 'Mark as “{status}”',

  'admin.title': 'Admin',
  'admin.description':
    'Overview, book review, user management, and direct database access.',
  'admin.tab.overview': 'Overview',
  'admin.tab.review': 'Review',
  'admin.tab.users': 'Users',
  'admin.tab.db': 'Database',
  'admin.denied': 'This page is for administrators only',
  'admin.deniedHint': 'The current account is not an administrator. Sign in with an admin account.',
  'admin.stat.users': 'Users',
  'admin.stat.admins': 'Admins',
  'admin.stat.history': 'Q&A records',
  'admin.stat.historyToday': 'Asked today',
  'admin.stat.shelf': 'Shelf books',
  'admin.stat.shelfToday': 'Added today',
  'admin.stat.pending': 'Awaiting review',
  'admin.stat.public': 'Public contributions',
  'admin.stat.sessions': 'Active sessions',
  'admin.stat.traits': 'Profile traits',
  'admin.corpus': 'Corpus',
  'admin.corpusValue': '{books} books · {chapters} chapters',
  'admin.storage': 'Database',
  'admin.storageValue': '{size} · {tables} tables',
  'admin.reviewEmpty': 'Nothing awaiting review',
  'admin.reviewEmptyHint': 'Books users asked to publish show up here.',
  'admin.approve': 'Approve',
  'admin.reject': 'Reject',
  'admin.notePlaceholder': 'Reason (shown to the author)',
  'admin.categoryPlaceholder': 'Category (optional)',
  'admin.from': 'Submitted by {email}',
  'admin.approved': 'Approved — the book is now on the public shelf.',
  'admin.rejected': 'Rejected.',
  'admin.publicTitle': 'Contributions on the public shelf',
  'admin.publicEmpty': 'No contributed books yet',
  'admin.removePublic': 'Take down',
  'admin.usersEmpty': 'No registered users yet',
  'admin.grantAdmin': 'Make admin',
  'admin.revokeAdmin': 'Revoke admin',
  'admin.resetPassword': 'Reset password',
  'admin.deleteUser': 'Delete user',
  'admin.shelfCount': '{count} books',
  'admin.newPassword': 'New password (at least 8 characters)',
  'admin.resetDone': 'Password reset. That user has been signed out.',
  'admin.you': 'you',
  'admin.dbTitle': 'Tables',
  'admin.dbRows': '{count} rows',
  'admin.dbEmpty': 'This table is empty',
  'admin.dbProtected': 'protected',
  'admin.dbHint':
    'Only table and column names on the allow-list are accepted; the password hash and salt cannot be edited here — use “Reset password”. Every write is recorded in the audit log.',
  'admin.dbSaved': 'Saved and recorded in the audit log.',
  'admin.prev': 'Previous',
  'admin.next': 'Next',
  'admin.pageOf': 'Page {page}',
  'admin.auditTitle': 'Recent operations',
  'admin.auditEmpty': 'No admin operations recorded yet',
